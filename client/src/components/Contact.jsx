...
export default function Contact({ data }) {
  ...
  const validate = (fd) => {
    ...
    else if (!/\S+@\S+\.\S+/.test(fd.reply_to)) e.reply_to = 'Enter a valid email';
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <p className="t2 mt-4 max-w-lg text-base leading-relaxed">
            Have a project in mind? I'm available for freelance work and always happy to discuss new ideas.
          </p>
        </motion.div>
            ...
            {[
              ...
              >
                ...
                <div>
                  ...
                  {href
                    ? <a href={href} className="text-sm t1 font-medium hover:text-accent-indigo transition-colors">{value}</a>
              ...
              {status === 'success' ? (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm t3">I'll get back to you as soon as possible.</p>
                  </div>
                  <button
                ...
                <form ref={formRef} onSubmit={handleSubmit} noValidate className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    {/* Name */}
                    <div>
                      <label className="block text-xs font-medium t2 mb-1.5">Name</label>
                      <input
                        name="from_name"
                        type="text"
                        placeholder="Your name"
                        className="contact-input"
                        style={errors.from_name ? { borderColor: '#ef4444' } : {}}
                      />
                      {errors.from_name && <p className="text-xs mt-1" style={{ color: '#ef4444' }}>{errors.from_name}</p>}
                    </div>
                    {/* Email */}
                    <div>
                      ...
                      <input
                        ...
                        className="contact-input"
                        style={errors.reply_to ? { borderColor: '#ef4444' } : {}}
                      />
                      {errors.reply_to && <p className="text-xs mt-1" style={{ color: '#ef4444' }}>{errors.reply_to}</p>}
                    </div>
                  </div>

                  {/* Subject */}
                  <div>
                    <label className="block text-xs font-medium t2 mb-1.5">Subject</label>
                    <input
                      name="subject"
                      type="text"
                  ...
                  {/* Message */}
                  <div>
                    <label className="block text-xs font-medium t2 mb-1.5">Message</label>
                    <textarea
                      name="message"
                      rows={5}
                  ...
                  {status === 'error' && (
                    <p className="text-xs px-3 py-2 rounded-lg" style={{ background: 'rgba(239,68,68,0.1)', color: '#ef4444' }}>
                      Something went wrong. Please email me directly at {data?.email}
                    </p>
                  )}
